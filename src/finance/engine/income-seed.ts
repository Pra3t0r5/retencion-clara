...
export const INCOME_SEED: IncomeEntry[] = [
  ...
  // Mar 2024: Monto en Cuenta ARS + USD separados (cláusula activada)
  { year: 2024, month: 3,  netUSD: 2978, grossARS: 4_845_286.69, netARS: 4_304_974.63, taxARS:  540_312.06, tcMEP: 1020, tcCCL: null, modality: 'crehana-usd', notes: 'Activación cláusula USD — pago $1,721,990 ARS + $2,978 USD' },
  { year: 2024, month: 4,  netUSD: 3919, grossARS: 4_634_579.63, netARS: 3_427_498.89, taxARS: 1_207_080.74, tcMEP: 1055, tcCCL: null, modality: 'crehana-usd' },
